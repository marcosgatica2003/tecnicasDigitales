\section{Los FPGA}
    \subsection{Definición}
        ...
        \begin{itemize}
            \item \textbf{LUT}: de \textit{Look-Up Table}, es una pequeña parte de la memoria SRAM con $2^N$ entradas que corresponden luego a las celdas de memoria, permitiendo representar cualquier función booleana porque cubre todas las combinaciones posibles según la cantidad de entradas que se den.
            \item \textbf{CLB}: de \textit{Configurable Logic Block}, contiene uno o varios LUTs más un Flip-Flop. Los LUTs hacen la lógica secuencial, y el Flip-Flop agrega la capacidad de memoria/secuencial.
        \end{itemize}
